        ...
        children:  [
          Row(
            ...
            children: [
              ...
              Column(
                children: const [
                  Text("Tiana vetrovs",style: TextStyle(fontSize: 18,fontWeight: FontWeight.w700),),
                  SizedBox(height: 8,),
                  Text("Passionate Writer",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),)
                ],
              ),
              SizedBox(width: 82,),
              FlatButton(
                  ...
                  child:Text("Edit Profile",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16,color: Colors.red),)
              )
            ],
          ),
          SizedBox(height: 16,),
          Text("I am a passionate writer, currently working as a  Content Creator at FizzBuzz. Based in Prague.",style: const TextStyle(fontSize: 17,fontWeight: FontWeight.w400),),
          SizedBox(height: 16,),
          Row(
            children: [
             ...
             SizedBox(width: 10,),
              Text("www.tianavetrovs.com",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w400),)
          ...
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text("Posts",style: TextStyle(fontWeight:FontWeight.w700 ,fontSize: 18),),
